                    ...
                    <?php foreach ($hoteles as $hotel) { ?>
                        <div class="mr-1 mb-3 border border-primary media">
                            <img style="height: 150px" class="w-25 mr-3"
                                 src="<?php echo $hotel->getImagenes()[0]->getUrl() ?>" alt="">
                            <div class="media-body">
                                <a class="link-primary text-decoration-none" href="../Controlador/singleHotelControlador.php?HotelId=<?php echo $hotel->getId(); ?>">
